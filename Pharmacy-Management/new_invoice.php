...
var customerName = document.getElementById('customers_name').value;
var invoiceNumber = document.getElementById('invoice_number').value;
var totalAmount = document.getElementById('total_amount').value;
var customerContactNumber = document.getElementById('customers_contact_number').value;
...
doc.text(20, 20,'                                         MEDICINE BILL RECEIPT                    ');
doc.text(20, 30,'                                                    MEDICO                           ')
doc.text(20, 50, 'Date: ' + invoiceDate);
doc.text(20, 60, 'Invoice Number: ' + invoiceNumber);
doc.text(20, 80,  'Customer Name: ' + customerName);
doc.text(20, 90,  'Customer phone no. : ' + customerContactNumber  );
doc.text(20, 110, '   Medicine Name:                                 QTY:  ');
doc.text(20, 120, '      Crosin                                                 3 ');
doc.text(20, 140, '                                                          Total Amount: ' + totalAmount);
doc.text(20, 150, '                                                          Total Discount: ' + totalDiscount);
doc.text(20, 160, '                                                          -------------------')
doc.text(20, 170, '                                                          Net Amount: ' + netTotal);
doc.text(20, 180, '                                                          Payment Mode: ' + paymentType);

// Add new page
doc.addPage();
doc.text(20, 20, '-group Name: ');
        ...
        <div class="row">
          ...
          <div class="row col col-md-12">
            ...
            <div id="print_button" class="col col-md-2 form-group float-right" style="display: none;">
              <label class="font-weight-bold" for=""></label>
              <button class="btn btn-warning form-control font-weight-bold" onclick="printInvoice2()">Print</button>
            </div>
            <div class="col col-md-4 form-group"></div>
            <div class="col col-md-2 form-group float-right">
              <label class="font-weight-bold" for="">Paid Amount :</label>
              <input type="text" class="form-control" name="total_discont" onkeyup="getChange(this.value);">
            </div>
            <div class="col col-md-2 form-group float-right">
